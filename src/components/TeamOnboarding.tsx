                      ...
                      <div style={{ display: 'flex', alignItems: isMobile ? 'flex-start' : 'center', gap: 12, padding: isMobile ? '11px 12px' : '13px 18px' }}>
                        ...
                        <div style={{ display: 'flex', gap: 5, flexShrink: 0 }}>
                          ...
                          <button
                            ...
                            style={{ background: 'none', border: `1px solid ${T.border}`, borderRadius: 6, padding: '3px 8px', color: T.muted, cursor: 'pointer', fontSize: 11 }}
                          >
                            Edit
                          </button>
                          <button
                            onClick={() => deleteTask(role.id, task.id)}
                            style={{ background: 'none', border: `1px solid ${T.redBorder}`, borderRadius: 6, padding: '3px 8px', color: T.red, cursor: 'pointer', fontSize: 11 }}
                          >
                            Delete
                          </button>
                        </div>
