...
const DATA = {
  ...
  tasks: [
    { category:"Lease & TI", task:"Sign Lease", due:"2026-04-15", status:"Not Started", priority:"High", checklist:JSON.stringify([{id:101,text:"Confirm TI allowance amount",done:false},{id:102,text:"Schedule walk-through inspection",done:false},{id:103,text:"Approve final floor layout",done:false},{id:104,text:"Review lease terms with attorney",done:false}]) },
    { category:"Lease & TI", task:"TI Buildout Start", due:"2026-04-25", status:"Not Started", priority:"High", checklist:JSON.stringify([{id:201,text:"Hire general contractor",done:false},{id:202,text:"Pull construction permits",done:false},{id:203,text:"Finalize design plans",done:false}]) },
    { category:"Menu & Bar", task:"Finalize Menu", due:"2026-04-20", status:"In Progress", priority:"High", checklist:JSON.stringify([{id:301,text:"Test all recipes with kitchen team",done:true},{id:302,text:"Calculate food cost % per item",done:false},{id:303,text:"Order initial ingredients",done:false},{id:304,text:"Design and print menus",done:false}]) },
    { category:"Permits", task:"Liquor License", due:"2026-04-10", status:"Overdue", priority:"Critical", checklist:JSON.stringify([{id:601,text:"File state application",done:true},{id:602,text:"Post public notice",done:true},{id:603,text:"Schedule hearing date",done:false},{id:604,text:"Submit supporting documents",done:false}]) },
    { category:"Permits", task:"Health Permit", due:"2026-04-18", status:"In Progress", priority:"High", checklist:JSON.stringify([{id:701,text:"Gather required documents",done:true},{id:702,text:"Schedule health inspection",done:false},{id:703,text:"Submit application",done:false}]) },
    { category:"Staffing", task:"Hire FOH & Kitchen Staff", due:"2026-04-25", status:"Not Started", priority:"High", checklist:JSON.stringify([{id:501,text:"Post job ads on Indeed",done:false},{id:502,text:"Screen applications",done:false},{id:503,text:"Schedule interviews",done:false}]) },
    { category:"Financials", task:"Finalize Budget", due:"2026-04-20", status:"In Progress", priority:"High", checklist:JSON.stringify([{id:901,text:"Record all startup costs",done:true},{id:902,text:"Forecast monthly expenses",done:false},{id:903,text:"Set up accounting software",done:false}]) },
    { category:"Operations", task:"Set Up POS", due:"2026-04-25", status:"Not Started", priority:"High", checklist:JSON.stringify([{id:1001,text:"Choose and purchase POS system",done:false},{id:1002,text:"Configure menu in system",done:false},{id:1003,text:"Train staff on POS",done:false}]) },
  ],
  menu_items: [
